...
const TAB_COLORS = {overview:T.blueBr,je:T.greenBr,recon:T.amberBr,flux:T.blueBr,cecl:T.greenBr,sox:T.amberBr,pbc:T.muted,callreport:T.purpleBr,axiomsl:T.purpleBr,regw:T.redBr};
...
export default function App() {
  ...
  const [uploads,setUploads] = useState({});   // { tabId: [{name,text}] }
  const [aiResults,setAIResults] = useState({}); // { tabId: string }
  const [running,setRunning] = useState(null); // tabId | null
